package tests.casestudies.havlak.havlakloopfinder;
...
import tests.casestudies.havlak.lsg.SimpleLoop;
...
public class HavlakLoopFinder {
	 ...
	 //     type[1] = BasicBlockClass.BB_NONHEADER;
...
//
    ...
    BasicBlock nodeW = nodes[w].getBb();
      ...
      // work the list...
	      ...
	      //
	      if ((nodePool.size() > 0) || (type[w] == "BB_SELF")) {
	        SimpleLoop loop = lsg.createNewLoop();

	        loop.setHeader(nodeW);
	        loop.setIsReducible(type[w] != "BB_IRREDUCIBLE");
