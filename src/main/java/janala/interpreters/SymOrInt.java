...
// For symbolic name, it must be of the format 'x1', 'x2' where the number is
// the
...
public final class SymOrInt {
  ...
  public boolean equals(Object o) {
    if (o == null) {
      ...
      return (sym == other.sym || sym.equals(other.sym)) && (constant == other.constant) && (isSym == other.isSym);
    } else {
      return false;
    }
  }
