...
/**
 * IntValue contains a pair of concrete value and a path constraint. Note that
 * the path constraint flip the boolean signs according to the evaluated
 * concrete value.
 */
public class IntValue extends Value {
  ...
  public boolean equals(Object other) {
    ...
    if (other instanceof IntValue) {
      ...
      return (this.concrete == otherVal.concrete
          && (this.symbolic == otherVal.symbolic || this.symbolic.equals(otherVal.symbolic))
    ...
    if (symbolic == null && nonIntConstraint == null) {
      ...
      if (symbolic.getOp() == COMPARISON_OPS.UN)
        return new IntValue(result ? 1 : 0,
            result ? symbolic.setop(COMPARISON_OPS.EQ) : symbolic.setop(COMPARISON_OPS.NE));
      else
        return new IntValue(result ? 1 : 0, result ? (SymbolicInt) symbolic.not() : symbolic);
    } else {
  ...
  public IntValue IFNE() {
    ...
    if (symbolic == null && nonIntConstraint == null) {
      ...
      if (symbolic.getOp() == COMPARISON_OPS.UN)
        return new IntValue(result ? 1 : 0,
            result ? symbolic.setop(COMPARISON_OPS.NE) : symbolic.setop(COMPARISON_OPS.EQ));
      else
        return new IntValue(result ? 1 : 0, result ? symbolic : (SymbolicInt) symbolic.not());
    } else {
  ...
  public IntValue IFLT() {
    if (symbolic == null) {
      ...
      boolean result = concrete < 0;
      return new IntValue(result ? 1 : 0,
          result ? symbolic.setop(COMPARISON_OPS.LT) : symbolic.setop(COMPARISON_OPS.GE));
    }
  }
  ...
  public IntValue IFGE() {
    if (symbolic == null) {
      ...
      boolean result = concrete >= 0;
      return new IntValue(result ? 1 : 0,
          result ? symbolic.setop(COMPARISON_OPS.GE) : symbolic.setop(COMPARISON_OPS.LT));
    }
  }
  ...
  public IntValue IFGT() {
    if (symbolic == null) {
      ...
      boolean result = concrete > 0;
      return new IntValue(result ? 1 : 0,
          result ? symbolic.setop(COMPARISON_OPS.GT) : symbolic.setop(COMPARISON_OPS.LE));
    }
  }
  ...
  public IntValue IFLE() {
    if (symbolic == null) {
      ...
      boolean result = concrete <= 0;
      return new IntValue(result ? 1 : 0,
          result ? symbolic.setop(COMPARISON_OPS.LE) : symbolic.setop(COMPARISON_OPS.GT));
    }
  }

  public IntValue IF_ICMPEQ(IntValue i2) {
    boolean result = (concrete == i2.concrete);
    COMPARISON_OPS op = result ? COMPARISON_OPS.EQ : COMPARISON_OPS.NE;
  ...
  public IntValue IF_ICMPNE(IntValue i2) {
    boolean result = (concrete != i2.concrete);
    COMPARISON_OPS op = result ? COMPARISON_OPS.NE : COMPARISON_OPS.EQ;
    if (symbolic == null && i2.symbolic == null) {
      return result ? IntValue.TRUE : IntValue.FALSE;
    } else if (symbolic != null && i2.symbolic != null) {
      SymbolicInt tmp = symbolic.subtract(i2.symbolic);
  ...
  public IntValue IF_ICMPLT(IntValue i2) {
    boolean result = (concrete < i2.concrete);
    COMPARISON_OPS op = result ? COMPARISON_OPS.LT : COMPARISON_OPS.GE;
    if (symbolic == null && i2.symbolic == null) {
      return result ? IntValue.TRUE : IntValue.FALSE;
    } else if (symbolic != null && i2.symbolic != null) {
      SymbolicInt tmp = symbolic.subtract(i2.symbolic);
  ...
  public IntValue IF_ICMPGE(IntValue i2) {
    boolean result = (concrete >= i2.concrete);
    COMPARISON_OPS op = result ? COMPARISON_OPS.GE : COMPARISON_OPS.LT;
    if (symbolic == null && i2.symbolic == null) {
      return result ? IntValue.TRUE : IntValue.FALSE;
    } else if (symbolic != null && i2.symbolic != null) {
      SymbolicInt tmp = symbolic.subtract(i2.symbolic);
  ...
  public IntValue IF_ICMPGT(IntValue i2) {
    boolean result = (concrete > i2.concrete);
    COMPARISON_OPS op = result ? COMPARISON_OPS.GT : COMPARISON_OPS.LE;
    if (symbolic == null && i2.symbolic == null) {
      return result ? IntValue.TRUE : IntValue.FALSE;
    } else if (symbolic != null && i2.symbolic != null) {
      SymbolicInt tmp = symbolic.subtract(i2.symbolic);
  ...
  public IntValue IF_ICMPLE(IntValue i2) {
    boolean result = (concrete <= i2.concrete);
    COMPARISON_OPS op = result ? COMPARISON_OPS.LE : COMPARISON_OPS.GT;
    if (symbolic == null && i2.symbolic == null) {
      return result ? IntValue.TRUE : IntValue.FALSE;
    } else if (symbolic != null && i2.symbolic != null) {
      SymbolicInt tmp = symbolic.subtract(i2.symbolic);
  ...
  public String toString() {
    return "IntValue{" + "symbolic=" + symbolic + ", concrete=" + concrete + ", nonIntConstraint=" + nonIntConstraint
        + '}';
  }
  ...
  public int hashCode() {
    ...
    hasher.putInt(symbolic.hashCode());
  ...
  public boolean isSynthetic() {
    return isSymbolicValue() && synthetic;
  }
}
