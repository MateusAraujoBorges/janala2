...
public class ConcolicInterpreter implements IVisitor {
  ...
  private Value getArrayElementObject(int iid, final ObjectValue ref, final IntValue i1, final Value val) {
    if (i1.symbolic != null) {
  ...
  private Value getArrayElementInt(int iid, final ObjectValue ref, final IntValue i1, final Value val) {
    if (i1.symbolic != null) {
  ...
  public void visitGETVALUE_Object(GETVALUE_Object inst) {
    ...
    if (peek == PlaceHolder.instance
        || (((ObjectValue) peek).address != ADDRESS_UNKNOWN && ((ObjectValue) peek).address != inst.v)) {
  ...
  public void visitINVOKEMETHOD_EXCEPTION(INVOKEMETHOD_EXCEPTION inst) {
    ...
    currentFrame.clear();
    currentFrame.push(PlaceHolder.instance); // placeholder for the exception
                                             // object
  }
