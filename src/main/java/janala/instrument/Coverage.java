...
public class Coverage implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof Coverage) {
      ...
      return classNameToCid.equals(other.classNameToCid) && cidmidToName.equals(other.cidmidToName)
          && covered.equals(other.covered) && (nBranches == other.nBranches) && (nCovered == other.nCovered);
    } else {
      return false;
    }
  }
  ...
  public String toString() {
    return "nBranches=" + nBranches + ", nCovered=" + nCovered + ", classNameToCid=" + classNameToCid.toString()
        + ", cidmidToName=" + cidmidToName.toString() + ", covered=" + covered.toString() + ", tmpCovered="
        + tmpCovered.toString();
  }
  ...
  public void printCoverage(PrintStream out) {
    ...
    out.println("Branch coverage with respect to covered classes = " + (100.0 * nCovered / nBranches) + "%");
    out.println("Branch coverage with respect to covered methods = " + (100.0 * nCovered / mtotals) + "%");
