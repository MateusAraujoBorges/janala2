...
public class SnoopInstructionMethodAdapter extends MethodVisitor implements Opcodes {
  ...
  public SnoopInstructionMethodAdapter(MethodVisitor mv, boolean isInit, Coverage coverage,
      GlobalStateForInstrumentation instrumentationState, ClassNames classNames) {
    super(ASM5, mv);
    this.isInit = isInit;
  ...
  /**
   * Add a GETVALUE call to synchronize the top stack with that of the symbolic
   * stack.
   */
  ...
  private void addTypeInsn(MethodVisitor mv, String type, int opcode, String name) {
    ...
    mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, name, "(IILjava/lang/String;)V", false);
  ...
  public void visitTypeInsn(int opcode, String type) {
    ...
    case NEW:
      ...
      mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, "NEW", "(IILjava/lang/String;I)V", false);
      mv.visitTypeInsn(opcode, type);
      addSpecialInsn(mv, 0); // for non-exceptional path
  ...
  public void visitFieldInsn(int opcode, String owner, String name, String desc) {
    ...
    case GETSTATIC:
      ...
      mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, "GETSTATIC", "(IIIILjava/lang/String;)V", false);
    ...
    case PUTSTATIC:
      ...
      mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, "PUTSTATIC", "(IIIILjava/lang/String;)V", false);
      mv.visitFieldInsn(opcode, owner, name, desc);
      addSpecialInsn(mv, 0); // for non-exceptional path
      break;
    case GETFIELD:
      ...
      mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, "GETFIELD", "(IIIILjava/lang/String;)V", false);
      mv.visitFieldInsn(opcode, owner, name, desc);
      addSpecialInsn(mv, 0); // for non-exceptional path
      addValueReadInsn(mv, desc, "GETVALUE_");
      break;
    case PUTFIELD:
      ...
      mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, "PUTFIELD", "(IIIILjava/lang/String;)V", false);
      mv.visitFieldInsn(opcode, owner, name, desc);
      addSpecialInsn(mv, 0); // for non-exceptional path
      break;
    default:
  ...
  private void addMethodWithTryCatch(int opcode, String owner, String name, String desc, boolean itf) {
    ...
    mv.visitLdcInsn(desc);
    mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, getMethodName(opcode),
    ...
    mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, "INVOKEMETHOD_EXCEPTION", "()V", false);
    mv.visitInsn(ATHROW);
  ...
  public void visitLdcInsn(Object cst) {
    ...
    if (cst instanceof Integer) {
      ...
      mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, "LDC", "(IILjava/lang/String;)V", false);
    } else {
      mv.visitMethodInsn(INVOKESTATIC, Config.instance.analysisClass, "LDC", "(IILjava/lang/Object;)V", false);
    }
    mv.visitLdcInsn(cst);
  }
  ...
  public void visitMaxs(int maxStack, int maxLocals) {
    ...
    mv.visitMaxs(maxStack + 8, maxLocals); // To change body of overridden
