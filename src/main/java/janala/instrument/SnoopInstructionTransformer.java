...
public class SnoopInstructionTransformer implements ClassFileTransformer {
  ...
  private static boolean shouldExclude(String cname) {
    String[] exclude = { "com/sun", "sun", "java", "jdk", "com/google/monitoring", "janala", "dk/brics" };
  ...
  @Override
  public byte[] transform(ClassLoader loader, String cname, Class<?> classBeingRedefined, ProtectionDomain d,
