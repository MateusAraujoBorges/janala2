...
public class AbstractRefineStrategy implements Strategy {
  ...
  private void removeElements(List<Element> history, int low, int high, int idx, int historySize) {
  ...
  public int searchWithIfPossibleAssert(List<Element> history, int low, int high, int historySize, History solver) {
    int to, from = low, ret;
