...
public class BranchElement extends Element {
  ...
  public void setIsForceTruth(boolean val) {
    isForceTruth = val;
  }

  public boolean getIsForceTruth() {
    return isForceTruth;
  }
  ...
  public String toString() {
    return "BranchElement{" + "branch=" + branch + ", done=" + done + ", pathConstraintIndex=" + pathConstraintIndex
        + ", iid=" + iid + ", isForceTruth=" + isForceTruth + '}';
  }
}
