...
public class TreeTests {
	...
	public void testConcolicTreeInsertionAndPruning() {
		...
		Constraint a1 = new SymbolicIntCompareConstraint(v1, c1, COMPARISON_OPS.GE);
		Constraint a2 = new SymbolicIntCompareConstraint(v2, c2, COMPARISON_OPS.GE);
		Constraint a3 = new SymbolicIntCompareConstraint(v3, c3, COMPARISON_OPS.GE);
		...
		// second insertion
		Constraint a2_1 = new SymbolicIntCompareConstraint(v2, c2, COMPARISON_OPS.LT);
	...
	public void testTreeCounting() throws IOException {
		...
		i1 = i1.add(-3); //constant is negative because constraints are represented like 'ax + b > 0'
	...
	public void testQuantolicPathSelection() {
		...
		Constraint a2 = new SymbolicIntCompareConstraint(v2, c2, COMPARISON_OPS.GE);
		Constraint a3 = new SymbolicIntCompareConstraint(v3, c3, COMPARISON_OPS.GE);
		Constraint a4 = new SymbolicIntCompareConstraint(v1, v2, COMPARISON_OPS.GE);
